...
# Before we look at lookup tabless, we can consider subsetting a vector
payouts <- c("DD" = 100, "7" = 80, "BBB" = 40, "BB" = 25,
             "B" = 10, "C" = 10, "0" = 0)
payouts # will return all the values
# but you can also index by name
payouts["DD"]
...
# 3 cherries are aleady covered by case 1
...
# remember that cherries could equal 0, 1, or 2 (3 is already covered)
# if we use the value of cherries as the index, and cherries = 0, then
c(0, 2, 5)[0]
# will return nothing
